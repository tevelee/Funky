...
{
    [dictionary funky_nilTolerantMap:^FunkyPair*(id key, id item) {
        return [FunkyPair pairWithKey:key value:item];
    }];
...
{
    [dictionary funky_values:^BOOL(id key, id value) {
        return YES;
    }];
